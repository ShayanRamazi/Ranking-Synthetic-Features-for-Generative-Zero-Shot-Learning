...
for epoch in range(opt.nepoch):
    ...
    if opt.gzsl:
        ...
        print('MY Classifier Seen Acc: {:.2f}%, Unseen Acc: {:.2f}%, H Acc: {:.2f}%'.format(cls.acc_fc_seen * 100,cls.acc_fc_unseen * 100,cls.acc_fc_H * 100))
        ...
        print('MY ZSL Classifier: {:.2f}%'.format(cls.cls_acc*100))
